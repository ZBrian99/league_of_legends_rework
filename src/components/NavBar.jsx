...
export const NavBar = () => {
	...
	return (
		<Nav visible={mobileMenu} ref={menuRef}>
			<NavLeftContent>
				<Link to='/champions/' title={'champions'} onClick={NavMenuClose}>
			...
			<MobileMenuContent>
				...
				<NavCenterContent>
					<NavLink to='universo/' onClick={NavMenuClose}>
						<NavText>Universe</NavText>
					</NavLink>
					<NavLink to='champions/' onClick={NavMenuClose}>
						<NavText>Champions</NavText>
					</NavLink>
					<NavLink to='regiones/' onClick={NavMenuClose}>
						<NavText>Regions</NavText>
					</NavLink>
				</NavCenterContent>
				<NavRightContent>
					<NavButton onClick={NavMenuClose}>Sign in</NavButton>
					<NavButton variant onClick={NavMenuClose}>
						Play Now
					</NavButton>
				</NavRightContent>
			</MobileMenuContent>
